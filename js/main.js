...
$(document).ready(function () {
    ...
    function openDropdown($dropdown) {
        if ($(window).width() < 992) {
            ...
            $dropdown.find('> .dropdown-menu').stop(true, true).slideDown(300);
            $dropdown.find('> a .fas.fa-caret-down').css('transform', 'rotate(180deg)');
        }
    }
    ...
    function closeDropdown($dropdown) {
        if ($(window).width() < 992) {
            ...
            $dropdown.find('> .dropdown-menu').stop(true, true).slideUp(300);
            $dropdown.find('> a .fas.fa-caret-down').css('transform', 'rotate(0deg)');
        }
    }
